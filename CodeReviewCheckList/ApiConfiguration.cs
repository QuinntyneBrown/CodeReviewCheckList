...
using System;
using CodeReviewCheckList.App_Start;
using CodeReviewCheckList.Utils;
using CodeReviewCheckList.Config;
using CodeReviewCheckList.Services;
using CodeReviewCheckList.Auth;
using CodeReviewCheckList.Filters;
...
namespace CodeReviewCheckList
{
    public class ApiConfiguration
    {
        public static void Install(HttpConfiguration config, IAppBuilder app)
        {
            ...
            config
                .EnableSwagger(c => c.SingleApiVersion("v1", "CodeReviewCheckList"))
                .EnableSwaggerUi();
